## Generated SDC file "detection_logic.sdc"
...
set_input_delay -clock clk_i_virt -max 0.550 [get_ports {input_i}]
set_input_delay -clock clk_i_virt -min 0.350 [get_ports {input_i}]
